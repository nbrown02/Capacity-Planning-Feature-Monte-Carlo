...
The Capacity Planning, Right-sizing & Epic Monte Carlo template is provided **free of charge** as an open-source resource to help teams visualize their workflow metrics/delivery dates. This template is a **static configuration file** and does **not** interact with user data, Jira instances, or external systems.

## Data Collection and Usage

The Capacity Planning, Right-sizing & Epic Monte Carlo template does **not**:
...
- Users are responsible for reviewing the template before applying it to their Jira/ADO instance.
...
For any privacy-related inquiries, please open an issue in the repository: [GitHub Issues](https://github.com/nbrown02/Capacity-Planning-Feature-Monte-Carlo/issues).
